...
if page == "The Crime Age Threshold": # the very fist page, if it is selected from the sidebar, the code runs displaying everything for the current page 
    ...
    df_aged_16_over = pd.read_csv("DataFiles/Crime_Aged 16+.csv") # ingesting the first dataset which is my main talking point and comparison (count)
    df_aged_16_over_percentage = pd.read_csv("DataFiles/16plus percentage.csv") # percentage for the dataset
    df_aged_16_under = pd.read_csv("DataFiles/Crime Aged under 16.csv") # percentage for under dataset
   ...
   df_map = pd.read_csv("DataFiles/Lat and Lon locations.csv") # loading the map dataset which is complete with the lat and lon so it works in the map function
   ...
   df_drug_related = pd.read_csv("DataFiles/Drug Related Crime.csv") # ingesting data
   ...
   df_knife_crime = pd.read_csv("DataFiles/Knife crime 2014 - 2024.csv")
   df_type_knife = pd.read_csv("DataFiles/Knife crime with type of knife reported.csv")
   df_firearm_crime = pd.read_csv("DataFiles/Crime involving Firearm.csv")
